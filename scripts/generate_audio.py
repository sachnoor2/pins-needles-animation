...
SCENES = [
    ...
    { "id": "s08", "fs": 2310, "fe": 2550, "text": "Kya aapne kabhi apne kisi body part ko 'so'te hue dekha hai? Comment mein batao!" },
    { "id": "s09", "fs": 2580, "fe": 2690, "text": "Aur aise hi videos ke liye subscribe karein." },
]

VOICES = {
    "Suresh": "hi-IN-SureshNeural", # MANDATORY VOICE - Professional Male
...
async def main():
    print("\n🚀 STARTING NARRATOR 1: SURESH (MANDATORY - Azure Native Hindi Male)")
